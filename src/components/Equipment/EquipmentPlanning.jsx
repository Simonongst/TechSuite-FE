    ...
    <Toast.Provider duration={3000}>
      <div className='space-y-2 text-gray-700'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <label className='text-sm font-medium' htmlFor='desktop'>
                ...
                <input
                  ...
                  disabled={
                    !equipmentData.find(
                      (equipment) => equipment.type === 'Desktop'
                    )?.isActive
                  }
                  value={form.desktop}
                  onChange={handleChange}
              ...
              <label className='text-sm font-medium' htmlFor='laptop'>
                ...
                <input
                  ...
                  disabled={
                    !equipmentData.find(
                      (equipment) => equipment.type === 'Laptop'
                    )?.isActive
                  }
                  onChange={handleChange}
                  className='mt-2 py-2 px-2 block w-full border-gray-300 rounded-md shadow-sm disabled:bg-gray-100'
          ...
          <fieldset className='mb-4'>
            <label className='text-sm font-medium' htmlFor='monitor'>
              ...
              <input
                ...
                disabled={
                  !equipmentData.find(
                    (equipment) => equipment.type === 'Monitor'
                  )?.isActive
                }
                value={form.monitor}
                onChange={handleChange}
          ...
          <fieldset className='mb-4'>
            <label className='text-sm font-medium' htmlFor='deskPhone'>
              ...
              <input
                ...
                disabled={
                  !equipmentData.find(
                    (equipment) => equipment.type === 'Desk Phone'
                  )?.isActive
                }
        ...
        <ToastMessage
          ...
          title={'Entry Saved'}
          description={'Your entry was saved successfully'}
        />
      </div>
    </Toast.Provider>
  );
